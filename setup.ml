...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2d3e8dc2bbb5e9864b888cefb8bba5b2) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-use-ocamlfind"; "-cflags"; "-w,-40"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/cakeplus/pa_qualified";
          synopsis =
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_qualified"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "pa_qualified";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "4\206\0015\154\212ie\227u\017Q\003\255\178\234";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
